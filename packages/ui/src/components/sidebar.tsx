...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: It's okay to set a cookie here
...
function SidebarMenuSubButton({
	// biome-ignore lint/a11y/useAnchorContent: I don't want to use a button here
	// biome-ignore lint/a11y/useValidAnchor: I don't want to use a button here
	render = <a />,
	size = "md",
	isActive = false,
	className,
