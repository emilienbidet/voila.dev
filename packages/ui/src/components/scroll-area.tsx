...
function Root({ className, ...props }: ComponentProps<typeof BaseScrollArea.Root>) {
	return <BaseScrollArea.Root className={cx("relative", className)} {...props} />;
}
...
function Content({ className, ...props }: ComponentProps<typeof BaseScrollArea.Content>) {
	return <BaseScrollArea.Content className={cx("w-fit min-w-full", className)} {...props} />;
}

function Scrollbar({ className, orientation = "vertical", ...props }: ComponentProps<typeof BaseScrollArea.Scrollbar>) {
	return (
...
function Thumb({ className, ...props }: ComponentProps<typeof BaseScrollArea.Thumb>) {
	return <BaseScrollArea.Thumb className={cx("bg-border relative flex-1 rounded-full", className)} {...props} />;
}
