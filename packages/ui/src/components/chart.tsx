...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
	...
	return (
		<style
			// biome-ignore lint/security/noDangerouslySetInnerHtml: It's safe to use dangerouslySetInnerHTML here because the content is static and controlled by the server.
